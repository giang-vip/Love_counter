...
import com.app.love_counter.data.repository.NameTestRepositoryImpl
import com.app.love_counter.databinding.ActivityNameTestResultBinding
...
class NameTestResultActivity : AppCompatActivity() {
    ...
    private val viewModel: NameTestResultViewModel by viewModels {
        ...
        val repository = NameTestRepositoryImpl(applicationContext)
