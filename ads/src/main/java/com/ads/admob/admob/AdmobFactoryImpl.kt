...
class AdmobFactoryImpl : AdmobFactory {
    ...
    override fun initAdmob(
        context: Application, afAdConfig: AfAdConfig, adCallback: AdmobCallBack
    ) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            MobileAds.setRequestConfiguration(
                RequestConfiguration.Builder().setTestDeviceIds(afAdConfig.listDevices).build()
            )
    ...
    private fun setupAdjust(application: Application, adjustConfig: AfAdjustConfig) {
        ...
        config.setOnEventTrackingSucceededListener { eventSuccessResponseData ->
            ...
            Log.d(
                TAG, "Event success data: $eventSuccessResponseData"
            )
        }
        ...
        config.setOnEventTrackingFailedListener { eventFailureResponseData ->
            ...
            Log.d(
                TAG, "Event failure data: $eventFailureResponseData"
            )
        }
        ...
        config.setOnSessionTrackingSucceededListener { sessionSuccessResponseData ->
            Log.d(
                TAG, "Session success callback called!"
            )
            Log.d(
                TAG, "Session success data: $sessionSuccessResponseData"
            )
        }
        ...
        config.setOnSessionTrackingFailedListener { sessionFailureResponseData ->
            Log.d(
                TAG, "Session failure callback called!"
            )
            Log.d(
                TAG, "Session failure data: $sessionFailureResponseData"
            )
        }
    ...
    override fun requestBannerAd(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToLoad(
                LoadAdError(
                    99, "BannerAd cancel Request And Show All Ads", "", null, null
                )
            )
            return
        }
        FirebaseTrackingManager.getInstance().logEvent("ad_banner_load", adPlacement)
        AdmobBannerFactory.getInstance().requestBannerAd(
            context,
            adId,
            adPlacement,
            collapsibleGravity,
                ...
                override fun onAdLoaded(data: ContentAd) {
                    ...
                    if (data is ContentAd.AdmobAd.ApBannerAd) {
                        data.adView.setOnPaidEventListener { adValue ->
                            ...
                            AdjustTrackingManager.pushTrackEventAdmob(
                                adValue, loadedAdapterResponseInfo, adPlacement
                            )
                            AdjustTrackingManager.pushTrackEvenAdjustRevenueAdMod(
                                adValue, afAdConfig.afAdjustConfig.adRevenueKey
                            )
                            AdjustTrackingManager.pushTrackEvenAdjustRevenueMintegral(
                                adValue, afAdConfig.afAdjustConfig.adRevenueMintegralKey
                            )
                            FacebookTrackingManager.getInstance().logPurchase(
                                adValue.valueMicros / 1000000.0, adValue.currencyCode
                            )
                            FacebookTrackingManager.getInstance().logAdImpression(
                                adValue.valueMicros / 1000000.0, adValue.currencyCode
                            )
                            FirebaseTrackingManager.getInstance().logRevenue(
                                adValue,
                                adPlacement,
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    if (reloadIfFirstFail) {
                        ...
                        FirebaseTrackingManager.getInstance()
                            .logEvent("ad_banner_load_failed", adPlacement)
                    }
                }
    ...
    override fun requestNativeAd(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToLoad(
                LoadAdError(
                    99, "ApNativeAd cancel Request And Show All Ads", "", null, null
                )
            )
            return
        }
        ...
        AdmobNativeFactory.getInstance().requestNativeAd(context, adId, object : NativeAdCallback {
            ...
            override fun onAdLoaded(data: ContentAd) {
                ...
                if (data is ContentAd.AdmobAd.ApNativeAd) {
                    data.nativeAd.setOnPaidEventListener { adValue ->
                        val loadedAdapterResponseInfo: AdapterResponseInfo? =
                            data.nativeAd.responseInfo?.loadedAdapterResponseInfo
                        AdjustTrackingManager.pushTrackEventAdmob(
                            adValue, loadedAdapterResponseInfo, adPlacement
                        )
                        AdjustTrackingManager.pushTrackEvenAdjustRevenueAdMod(
                        ...
                        FacebookTrackingManager.getInstance()
                            .logPurchase(adValue.valueMicros / 1000000.0, adValue.currencyCode)
                        FacebookTrackingManager.getInstance()
                            .logAdImpression(adValue.valueMicros / 1000000.0, adValue.currencyCode)
                        FirebaseTrackingManager.getInstance().logRevenue(
                            adValue,
                            adPlacement,
                            loadedAdapterResponseInfo?.adapterClassName,
            ...
            override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                if (reloadIfFirstFail) {
                    ...
                    adCallback.onAdFailedToLoad(loadAdError)
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_native_load_failed", adPlacement)
                }
            }
    ...
    override fun populateNativeAdView(
        ...
        FirebaseTrackingManager.getInstance().logEvent("ad_native_call_show", adPlacement)
        when (nativeAd) {
    ...
    override fun requestInterstitialAds(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToLoad(
                LoadAdError(
                    99, "ApInterstitialAd cancel Request And Show All Ads", "", null, null
                )
            )
            return
        }
            ...
            .requestInterstitialAd(context, adId, adPlacement, object : InterstitialAdCallback {
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    if (reloadIfFirstFail) {
                        ...
                        adCallback.onAdFailedToLoad(loadAdError)
                        FirebaseTrackingManager.getInstance()
                            .logEvent("ad_inter_load_failed", adPlacement)
                    }
                }
                ...
                override fun onAdImpression() {
                    adCallback.onAdImpression()
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_inter_impression", adPlacement)
                }

                override fun onAdFailedToShow(adError: AdError) {
                    adCallback.onAdFailedToShow(adError)
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_inter_show_failed", adPlacement)
                }
    ...
    override fun showInterstitial(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToShow(
                AdError(
                    99, "ApInterstitialAd cancel Request And Show All Ads", "", null
                )
            )
            return
        }
        when (interstitialAd) {
            is ContentAd.AdmobAd.ApInterstitialAd -> {
                AdmobInterstitialAdFactory.getInstance().showInterstitial(
                    context, interstitialAd.interstitialAd, object : InterstitialAdCallback {
                        override fun onNextAction() {
                            adCallback.onNextAction()
                        }
                        ...
                        override fun onAdClose() {
                            ...
                            adCallback.onAdClose()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_inter_closed", adPlacement)
                        }

                        override fun onInterstitialShow() {
                            adCallback.onInterstitialShow()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_inter_open", adPlacement)
                        }

                        override fun onAdLoaded(data: ContentAd) {
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_inter_loaded", adPlacement)
                            adCallback.onAdLoaded(data)
                        }
                        ...
                        override fun onAdClicked() {
                            adCallback.onAdClicked()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_inter_clicked", adPlacement)
                        }
    ...
    override fun requestAppOpenAds(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToLoad(
                LoadAdError(
                    99, "ApAppOpenAd cancel Request And Show All Ads", "", null, null
                )
            )
            return
        }
        ...
        AdmobAppOpenAdFactory.getInstance()
            .requestAppOpenAd(context, adId, adPlacement, object : AppOpenAdCallBack {
                ...
                override fun onAppOpenAdClose() {
                    ...
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_app_open_closed", adPlacement)
                }

                override fun onAdLoaded(data: ContentAd) {
                    Log.d(TAG, "load $adPlacement success")
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_app_open_loaded", adPlacement)
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    if (reloadIfFirstFail) {
                        ...
                        adCallback.onAdFailedToLoad(loadAdError)
                        FirebaseTrackingManager.getInstance()
                            .logEvent("ad_app_open_load_failed", adPlacement)
                    }
                }
                ...
                override fun onAdClicked() {
                    adCallback.onAdClicked()
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_app_open_clicked", adPlacement)
                }

                override fun onAdImpression() {
                    adCallback.onAdImpression()
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_app_open_impression", adPlacement)
                }

                override fun onAdFailedToShow(adError: AdError) {
                    adCallback.onAdFailedToShow(adError)
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_app_open_show_failed", adPlacement)
                }
            })
    }

    override fun showAppOpen(
        context: Context, appOpenAd: ContentAd?, adPlacement: String?, adCallback: AppOpenAdCallBack
    ) {
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToShow(
                AdError(
                    99, "ApAppOpenAd cancel Request And Show All Ads", "", null
                )
            )
            return
        }
        when (appOpenAd) {
            is ContentAd.AdmobAd.ApAppOpenAd -> {
                AdmobAppOpenAdFactory.getInstance()
                    .showAppOpen(context, appOpenAd.appOpenAd, adPlacement,object : AppOpenAdCallBack {
                        ...
                        override fun onAppOpenAdShow() {
                            adCallback.onAppOpenAdShow()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_app_open_show", adPlacement)
                        }
    ...
    override fun requestRewardAd(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToLoad(
                LoadAdError(
                    99, "ApRewardAd cancel Request And Show All Ads", "", null, null
                )
            )
            return
        }
        Log.d(TAG, "load $adPlacement")
        FirebaseTrackingManager.getInstance().logEvent("ad_reward_load", adPlacement)
        AdmobRewardAdFactory.getInstance()
            .requestRewardAd(context, adId, object : RewardAdCallBack {
                ...
                override fun onUserEarnedReward(rewardItem: RewardItem?) {
                    ...
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_reward_user_earned", adPlacement)
                }
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    if (reloadIfFirstFail) {
                        ...
                        adCallback.onAdFailedToLoad(loadAdError)
                        FirebaseTrackingManager.getInstance()
                            .logEvent("ad_reward_load_failed", adPlacement)
                    }
                }
                ...
                override fun onAdImpression() {
                    adCallback.onAdImpression()
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_reward_impression", adPlacement)
                }

                override fun onAdFailedToShow(adError: AdError) {
                    adCallback.onAdFailedToShow(adError)
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_reward_show_failed", adPlacement)
                }
            })
    }
    ...
    override fun showRewardAd(
        ...
        if (isCancelRequestAndShowAllAds) {
            adCallback.onAdFailedToShow(
                AdError(
                    99, "ApRewardAd cancel Request And Show All Ads", "", null
                )
            )
            return
        }
                ...
                AdmobRewardAdFactory.getInstance()
                    .showRewardAd(activity, rewardedAd.rewardAd, object : RewardAdCallBack {
                        override fun onAdClose() {
                            adCallback.onAdClose()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_closed", adPlacement)
                        }

                        override fun onUserEarnedReward(rewardItem: RewardItem?) {
                            adCallback.onUserEarnedReward(rewardItem)
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_user_earned", adPlacement)
                        }

                        override fun onRewardShow() {
                            adCallback.onRewardShow()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_show", adPlacement)
                        }

                        override fun onAdLoaded(data: ContentAd) {
                            adCallback.onAdLoaded(data)
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_load", adPlacement)
//                            if (data is ContentAd.AdmobAd.ApRewardAd) {
//                                data.rewardAd.setOnPaidEventListener { adValue ->
...
//                            }
                        ...
                        override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                            adCallback.onAdFailedToLoad(loadAdError)
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_load_failed", adPlacement)
                        }

                        override fun onAdClicked() {
                            adCallback.onAdClicked()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_clicked", adPlacement)
                        }

                        override fun onAdImpression() {
                            adCallback.onAdImpression()
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_impression", adPlacement)
                        }

                        override fun onAdFailedToShow(adError: AdError) {
                            adCallback.onAdFailedToShow(adError)
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_mrec_show_failed", adPlacement)
                        }
                    })
