...
class AppOpenAdManager {
    ...
    fun loadAd(context: Context) {
        ...
        FirebaseTrackingManager.getInstance()
            .logEvent("ad_open_request", appResumeAdConfig!!.adPlacement)
        ...
        AppOpenAd.load(
            context, adUnitId, request, object : AppOpenAd.AppOpenAdLoadCallback() {
                ...
                override fun onAdLoaded(ad: AppOpenAd) {
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_open_loaded", appResumeAdConfig!!.adPlacement)
                    ...
                    try {
                        ad.setOnPaidEventListener {
                            ...
                            AdjustTrackingManager.pushTrackEventAdmob(
                                it, loadedAdapterResponseInfo, appResumeAdConfig?.adPlacement
                            )
                            AdjustTrackingManager.pushTrackEvenAdjustRevenueAdMod(
                                it, AdmobFactory.INSTANCE.getConfig().afAdjustConfig.adRevenueKey
                            )
                            ...
                            FacebookTrackingManager.getInstance()
                                .logPurchase(it.valueMicros / 1000000.0, it.currencyCode)
                            FacebookTrackingManager.getInstance()
                                .logAdImpression(it.valueMicros / 1000000.0, it.currencyCode)
                ...
                override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                    FirebaseTrackingManager.getInstance()
                        .logEvent("ad_open_load_failed", appResumeAdConfig!!.adPlacement)
                    isLoadingAd = false
    ...
    fun showAdIfAvailable(activity: Activity, adCallback: AppOpenAdCallBack) {
        ...
        FirebaseTrackingManager.getInstance()
            .logEvent("ad_open_call_show", appResumeAdConfig!!.adPlacement)
                ...
                (appOpenAd as ContentAd.AdmobAd.ApAppOpenAd).appOpenAd.fullScreenContentCallback =
                    object : FullScreenContentCallback() {
                        ...
                        override fun onAdDismissedFullScreenContent() {
                            ...
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_open_closed", appResumeAdConfig!!.adPlacement)
                            appOpenAd = null
                            isShowingAd = false
                        ...
                        override fun onAdFailedToShowFullScreenContent(adError: AdError) {
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_open_show_failed", appResumeAdConfig!!.adPlacement)
                            appOpenAd = null
                            isShowingAd = false
                        ...
                        override fun onAdShowedFullScreenContent() {
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_open_open", appResumeAdConfig!!.adPlacement)
                        ...
                        override fun onAdClicked() {
                            ...
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_open_clicked", appResumeAdConfig!!.adPlacement)
                        }
                        ...
                        override fun onAdImpression() {
                            ...
                            FirebaseTrackingManager.getInstance()
                                .logEvent("ad_open_impression", appResumeAdConfig!!.adPlacement)
                        }
                    }
                isShowingAd = true
